...
{
  new (message_memory) ground_bot::msg::Pwm(_init);
}

void Pwm_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ground_bot::msg::Pwm *>(message_memory);
  typed_message->~Pwm();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Pwm_message_member_array[2] = {
  {
    ...
    offsetof(ground_bot::msg::Pwm, pwm_left_motor),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ground_bot::msg::Pwm, pwm_right_motor),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::ground_bot::msg::rosidl_typesupport_introspection_cpp::Pwm_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ground_bot, msg, Pwm)() {
  return &::ground_bot::msg::rosidl_typesupport_introspection_cpp::Pwm_message_type_support_handle;
}
