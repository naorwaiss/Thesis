...
class DroneTunnerWindow(QWidget):
    ...
    def update_label(self, msg):
        # Update the table with the received PID values
        # Assuming PidConsts message has the following structure:
        # rate_roll_p, rate_roll_i, rate_roll_d
        # rate_pitch_p, rate_pitch_i, rate_pitch_d
        # stable_roll_p, stable_roll_i, stable_roll_d
        # stable_pitch_p, stable_pitch_i, stable_pitch_d
