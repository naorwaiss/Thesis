...
private:
    void joyCallback(const sensor_msgs::msg::Joy::SharedPtr msg)
    {
        ...
        if (msg->axes.size() >= 2) {
            cmd_msg.twist.linear.x = msg->axes[1] * max_speed_;         // Forward/Backward
            cmd_msg.twist.angular.z = msg->axes[2] * max_steering_angle_; // Left/Right steering
        }
