...
#include "ground_bot/msg/detail/pwm__rosidl_typesupport_fastrtps_c.h"
...
using _Pwm__ros_msg_type = ground_bot__msg__Pwm;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: pwm_left_motor
  {
    cdr << ros_message->pwm_left_motor;
  }

  // Field name: pwm_right_motor
  {
    cdr << ros_message->pwm_right_motor;
  }
...
size_t get_serialized_size_ground_bot__msg__Pwm(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name pwm_left_motor
  {
    size_t item_size = sizeof(ros_message->pwm_left_motor);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pwm_right_motor
  {
    size_t item_size = sizeof(ros_message->pwm_right_motor);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Pwm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ground_bot__msg__Pwm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ground_bot
size_t max_serialized_size_ground_bot__msg__Pwm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ground_bot__msg__Pwm;
    is_plain =
      (
      offsetof(DataType, pwm_right_motor) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Pwm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ground_bot__msg__Pwm(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ground_bot, msg, Pwm)() {
