...
static const _RollerData_type_support_symbol_names_t _RollerData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ground_bot, msg, RollerData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ground_bot, msg, RollerData)),
  }
};
...
{
  return &::ground_bot::msg::rosidl_typesupport_cpp::RollerData_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ground_bot, msg, RollerData)() {
  return get_message_type_support_handle<ground_bot::msg::RollerData>();
}
