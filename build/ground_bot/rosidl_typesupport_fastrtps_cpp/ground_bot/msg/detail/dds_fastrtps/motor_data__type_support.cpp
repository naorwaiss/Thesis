...
#include "ground_bot/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ground_bot::msg::MotorData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ground_bot::msg::MotorData & ros_message)
{
  // Member: left_motor
  cdr >> ros_message.left_motor;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ground_bot::msg::MotorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ground_bot::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ground_bot::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &ground_bot::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ground_bot, msg, MotorData)() {
  return &ground_bot::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
