...
#include "ground_bot/msg/detail/pwm__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ground_bot::msg::Pwm & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ground_bot::msg::Pwm & ros_message)
{
  // Member: pwm_left_motor
  cdr >> ros_message.pwm_left_motor;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ground_bot::msg::Pwm;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ground_bot::msg::Pwm *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ground_bot::msg::Pwm *>(
    untyped_ros_message);
...
get_message_type_support_handle<ground_bot::msg::Pwm>()
{
  return &ground_bot::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ground_bot, msg, Pwm)() {
  return &ground_bot::msg::typesupport_fastrtps_cpp::_Pwm__handle;
}
