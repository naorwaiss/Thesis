...
#include "hamma_bot/msg/detail/pwm__rosidl_typesupport_fastrtps_c.h"
...
using _Pwm__ros_msg_type = hamma_bot__msg__Pwm;
...
size_t get_serialized_size_hamma_bot__msg__Pwm(
  const void * untyped_ros_message,
...
static uint32_t _Pwm__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_hamma_bot__msg__Pwm(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_hamma_bot
size_t max_serialized_size_hamma_bot__msg__Pwm(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hamma_bot__msg__Pwm;
    is_plain =
      (
...
static size_t _Pwm__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_hamma_bot__msg__Pwm(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, hamma_bot, msg, Pwm)() {
