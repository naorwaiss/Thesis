...
#include "hamma_bot/msg/detail/motor_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = hamma_bot::msg::MotorData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const hamma_bot::msg::MotorData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<hamma_bot::msg::MotorData *>(
    untyped_ros_message);
...
{
  return &hamma_bot::msg::typesupport_fastrtps_cpp::_MotorData__handle;
}
